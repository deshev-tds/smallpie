...
"""
    ...
    config.TRAITS_FILE.parent.mkdir(parents=True, exist_ok=True)
    with config.TRAITS_FILE.open("a", encoding="utf-8") as f:
        f.write("\n\n==== NEW SESSION ====\n")
        f.write(traits)
    print("[traits] traits file updated at", config.TRAITS_FILE)
